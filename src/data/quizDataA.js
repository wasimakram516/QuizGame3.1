const quizDataSection1 = [
  ...
  },
  {
    ...
    options: [
      { text: 'A: Biological hazards', isCorrect: false },
      { text: 'B: Physical hazards', isCorrect: false },
      { text: 'C: Electrical hazards', isCorrect: false },
      { text: 'D: Personal disagreements', isCorrect: true },  // Correct Answer
    ],
  },
  {
    question: 'What should an employee do if they identify a hazard?',
    options: [
      { text: 'A: Ignore it if it doesn’t affect them', isCorrect: false },
      { text: 'B: Report it to their supervisor immediately', isCorrect: true },  // Correct Answer
      { text: 'C: Attempt to fix the hazard without permission', isCorrect: false },
      { text: 'D: Wait until the end of their shift to report', isCorrect: false },
    ],
  },
  {
    question: 'Which of the following is an example of a chemical hazard?',
    options: [
      { text: 'A: Exposure to loud machinery', isCorrect: false },
      { text: 'B: A slippery floor', isCorrect: false },
      { text: 'C: Handling corrosive substances', isCorrect: true },  // Correct Answer
      { text: 'D: Poor lighting in a work area', isCorrect: false },
    ],
  },
  {
