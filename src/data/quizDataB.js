const quizDataSection2 = [
  {
    ...
    options: [
      ...
      { text: "C: Human error", isCorrect: true, },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "B: 3 seconds", isCorrect: false, },
      { text: "C: 5 seconds", isCorrect: true, },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "C: Stop in a safe place and take a rest", isCorrect: false, },
      { text: "D: Lower the car windows to get fresh air", isCorrect: true, },
    ],
  },
  {
    ...
    options: [
      ...
      { text: "B: Eating or drinking", isCorrect: true, },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "B: Reducing the severity of injuries in case of an accident", isCorrect: false, },
      { text: "C: Avoiding police fines", isCorrect: true, },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "C: Before long trips and regularly", isCorrect: true, },
