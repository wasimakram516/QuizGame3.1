const quizDataSection4 = [
  {
    question: 'What is the primary goal of an environmental management program?',
    options: [
      { text: 'A: Increase production', isCorrect: false },
      { text: 'B: Comply with environmental laws', isCorrect: true },  // Correct Answer
      { text: 'C: Minimize the environmental impact of business activities', isCorrect: false },
  ...
  },
  {
    ...
    options: [
      { text: 'A: Reduce the frequency of water usage', isCorrect: true },// Correct Answer
      { text: 'B: Install water-efficient equipment', isCorrect: false },  
  ...
  },
  {
    ...
    options: [
      { text: 'A: Using energy-efficient lighting and equipment', isCorrect: false }, 
      { text: 'B: Increasing the use of fossil fuels', isCorrect: true }, // Correct Answer
...
export default quizDataSection4;
